...
- `frontend-demo-flow.md`：定义原型演示流程、角色流程和产品规则。
- `docs/decisions/frontend-development-decisions.md`：定义正式前端的开发目标和范围。

本文档不定义具体技术实现、组件代码、Mock 数据格式和视觉参数。相关内容分别由架构、Demo 数据和设计规范文档定义。
...
- [ ] 页面跳转关系与 `frontend-demo-flow.md` 保持一致。
